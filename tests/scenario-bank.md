...
| Phase 3 paralysis cap (A3) | Tests 2, 4, 6, 8 each have exactly 3 hypotheses — all under the 3-hypothesis rule-out cap. No scenario currently exercises cap-firing (deferred to Stage B pilot for empirical case where cap saves a session) | ✅ Cap doesn't break existing scenarios |
